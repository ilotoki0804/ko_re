...
def match(pattern: str, string: str, flags: int | RegexFlag = 0):
    """Try to apply the pattern at the start of the string, returning
    a Match object, or None if no match was found."""
    return _compile(pattern, flags).match(string)


def fullmatch(pattern: str, string: str, flags: int | RegexFlag = 0):
    """Try to apply the pattern to all of the string, returning
    a Match object, or None if no match was found."""
    return _compile(pattern, flags).fullmatch(string)


def search(pattern: str, string: str, flags: int | RegexFlag = 0):
    """Scan through string looking for a match to the pattern, returning
    a Match object, or None if no match was found."""
    return _compile(pattern, flags).search(string)


def sub(pattern: str, repl: str | Callable[[Match[str]], str], string: str, count: int = 0, flags=0):
...
def subn(pattern: str, repl: str | Callable[[Match[str]], str], string: str, count: int = 0, flags=0):
...
def findall(pattern: str, string: str, flags: int | RegexFlag = 0):
...
def finditer(pattern: str, string: str, flags: int | RegexFlag = 0):
...
def compile(pattern: str, flags: int | RegexFlag = 0):
